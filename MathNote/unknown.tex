...
\bu{}{}
已知$a,b\in\RR^{+}$且$\frac{\sin^{4}\alpha}{a^{n}}+\frac{\cos^{4}\alpha}{b^{n}}=\frac{1}{a^{n}+b^{n}}$,
求证: $\frac{\sin^{8}\alpha}{a^{3n}}+\frac{\cos^{8}\alpha}{b^{3n}}=\frac{1}{\left(a^{n}+b^{n}\right)^{3}}$.
\eu
...
证明: 对于任意的自然数$n$, 
\bee
\sum_{i=1}^n\frac{\sqrt{i(i+1)(i+2)(i+3)}}{i^2(i+1)^2}<2.
\eee
\eu
\ba
...
\ba
\bee
\frac{\sqrt{(n+2)(n+3)}}{n(n+1)\sqrt{n^{2}+n}}
  <\frac{n+7/2}{\paren{n-\frac{1}{4}}\paren{n+\frac{3}{4}}\paren{n+\frac{7}{4}}}
\eee
则有
\bee
\sum_{k=1}^{n}\frac{\sqrt{(k+2)(k+3)}}{k(k+1)\sqrt{k^{2}+k}}<\frac{32n(n+2)}{(4n+3)(4n+7)}
\eee
\ea
...
\bu{2014-05-18}{}
\bee
(0,1)\nsubseteq\bigcup_{\frac{p}{q}\in(0,1)\cap\QQ}\paren{\frac{p}{q}-\frac{1}{4q^2}, \frac{p}{q}+\frac{1}{4q^2}}.
\eee
\eu
...
设数列$\{x_n\}$满足条件
\bee
0\le x_{m+n}\le x_m+x_n\quad(m,n\in\pNN),
\eee
