...
\bee
\sum_{i=1}^n\frac{x_i}{\sqrt{1-x_i}}\ge\frac1n\paren{\sum x_i}\cdot\paren{\sum\frac1{\sqrt{1-x_i}}}
  =\frac1n\sum\frac1{\sqrt{1-x_i}}\ge\left[\frac1n\sum\paren{\frac1{\sqrt{1-x_i}}}^{-2}\right]^{-1/2}
  =\left[\frac1n\sum(1-x_i)\right]^{-1/2}=\sqrt{\frac{n}{n-1}}.
\eee
由Cauchy不等式得
\bee
